...
imgs = {}
for i in range(1, 4):
   image = pygame.image.load(os.path.join('assets', 'towers', 'fire', 'base' + str(i) + '.png'))
   imgs['base' + str(i)] = pygame.transform.scale(image, (64, 96))
   image = pygame.image.load(os.path.join('assets', 'towers', 'fire', 'back' + str(i) + '.png'))
   imgs['back' + str(i)] = pygame.transform.scale(image, (58, 16))
   image = pygame.image.load(os.path.join('assets', 'towers', 'fire', 'front' + str(i) + '.png'))
...
for i in range(1, 6):
   image = pygame.image.load(os.path.join('assets', 'towers', 'fire', 'explode' + str(i) + '.png'))
...
class Fire(Towers):
   ...
   def move_with_base(self):
      ...
      self.front = self.back[0], self.back[1] + (self.height / 6) - 10, self.all_images['front' + str(self.level)]
